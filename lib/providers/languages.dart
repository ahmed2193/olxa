...
class Languages with ChangeNotifier {
  ...
  Map<String, String> _english = {
    ...
    'Top Picks in Olxagri': "Top Picks in Olxagri",
  ...
  Map<String, String> _arabic = {
    ...
    'Top Picks in Olxagri': "أعلى اللقطات في الإعلانات المبوبة",
  ...
  Map<String, String> _french = {
    ...
    'Top Picks in Olxagri': "Meilleurs choix dans les annonces",
