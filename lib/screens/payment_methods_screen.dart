...
import 'package:Mark_Classified/payment/PaypalPayment.dart';
...
class _PaymentMethodsScreenState extends State<PaymentMethodsScreen> {
  ...
  void onPaymentFailure() {
    ScaffoldMessenger.of(context).showSnackBar(SizedBox(child: snackBar("Payment Failed")) as SnackBar);
  }
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SizedBox(child: snackBar("Payment Successful")) as SnackBar);
  }
  ...
  void _handlerExternalWallet(ExternalWalletResponse response) {
    ScaffoldMessenger.of(context).showSnackBar(SizedBox(child: snackBar("External Wallet")) as SnackBar);
  }
      ...
      if (response != null) {
        ...
        if (response.success!) {
          ...
          ScaffoldMessenger.of(context)
              .showSnackBar(SizedBox(child: snackBar("Payment Successful")) as SnackBar);
        } else if (response.success!) {
          ScaffoldMessenger.of(context)
              .showSnackBar(SizedBox(child: snackBar("Payment Cancelled")) as SnackBar);
        } else
          onPaymentFailure();
      } else {
